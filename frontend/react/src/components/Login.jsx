    ...
    <div className="flex items-center min-h-screen bg-gray-800">
        <div className="container mx-auto">
            <div className="max-w-md my-0 mx-0">
              <img className="absolute top-0 right-0 flex h-screen" src={Background} alt="back"></img>
                    ...
                    <form>
                        ...
                        <div className="flex justify-between">
                          <div className="form-check">
                            ...
                            <label htmlFor="remember" className="form-check-label inline-block text-gray-400">Remember me</label>
                          </div>
